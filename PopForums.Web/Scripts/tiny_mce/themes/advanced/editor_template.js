...
(function(tinymce) {
	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		stateControls : ['bold', 'italic', 'bullist', 'numlist', 'blockquote'],
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_buttons1: "bold,italic,|,bullist,numlist,|,undo,redo,|,blockquote,link,unlink,image,removeformat",
