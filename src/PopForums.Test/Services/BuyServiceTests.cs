...
public class BuyServiceTests
{
	...
	[Fact]
	public async Task BuyNewReturnsFailureWhenSkuIsNull()
	{
	...
	[Fact]
	public async Task BuyNewReturnsFailureWhenSkuIsNotActive()
	{
		var service = GetService();
	...
	[Fact]
	public async Task BuyNewReturnsFailureWhenCreateCustomerFails()
	{
		var service = GetService();
		var sku = GetActiveSku();
		_skuRepository.Get(SkuID).Returns(Task.FromResult(sku));
	...
	[Fact]
	public async Task BuyNewReturnsFailureWhenChargeCustomerFails()
	{
		var service = GetService();
		var sku = GetActiveSku();
		_skuRepository.Get(SkuID).Returns(Task.FromResult(sku));
	...
	[Fact]
	public async Task BuyNewSucceedsAndUpdatesEverythingWhenNoExistingExpiration()
	{
		var service = GetService();
	...
	[Fact]
	public async Task BuyNewExtendsExistingFutureExpiration()
	{
		var service = GetService();
	...
	[Fact]
	public async Task BuyNewResetsExpirationFromTodayWhenExistingExpirationIsPast()
	{
		var service = GetService();
	...
	[Fact]
	public async Task UpdatePaymentMethodReturnsFailureWhenCreateCustomerFails()
	{
		var service = GetService();
		var user = GetUser();
		_userRepository.GetUser(UserID).Returns(Task.FromResult(user));
	...
	[Fact]
	public async Task UpdatePaymentMethodSucceeds()
	{
		var service = GetService();
		var user = GetUser();
		_userRepository.GetUser(UserID).Returns(Task.FromResult(user));
